...
MODULE MKL_DFTI
  ...
  INTERFACE DftiCreateDescriptor
     ...
     FUNCTION dfti_create_descriptor_1d(desc, precision, domain, dim, length)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_create_descriptor_1d' :: dfti_create_descriptor_1d
     ...
     FUNCTION dfti_create_descriptor_highd(desc, precision, domain, dim,length)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_create_descriptor_highd' :: dfti_create_descriptor_highd
     ...
     FUNCTION dfti_create_descriptor_s_1d(desc, s, dom, one, dim)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_create_descriptor_s_1d' :: dfti_create_descriptor_s_1d
     ...
     FUNCTION dfti_create_descriptor_s_md(desc, s, dom, many, dims)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_create_descriptor_s_md' :: dfti_create_descriptor_s_md
     ...
     FUNCTION dfti_create_descriptor_d_1d(desc, d, dom, one, dim)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_create_descriptor_d_1d' :: dfti_create_descriptor_d_1d
     ...
     FUNCTION dfti_create_descriptor_d_md(desc, d, dom, many, dims)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_create_descriptor_d_md' :: dfti_create_descriptor_d_md
  ...
  INTERFACE DftiCopyDescriptor
     ...
     FUNCTION dfti_copy_descriptor_external(desc, new_desc)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_copy_descriptor_external' :: dfti_copy_descriptor_external
  ...
  INTERFACE DftiCommitDescriptor
     ...
     FUNCTION dfti_commit_descriptor_external(desc)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_commit_descriptor_external' :: dfti_commit_descriptor_external
  ...
  INTERFACE DftiSetValue
     ...
     FUNCTION dfti_set_value_intval(desc, OptName, IntVal)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_set_value_intval' :: dfti_set_value_intval
     ...
     FUNCTION dfti_set_value_sglval(desc, OptName, sglval)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_set_value_sglval' :: dfti_set_value_sglval
     ...
     FUNCTION dfti_set_value_dblval(desc, OptName, DblVal)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_set_value_dblval' :: dfti_set_value_dblval
     ...
     FUNCTION dfti_set_value_intvec(desc, OptName, IntVec)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_set_value_intvec' :: dfti_set_value_intvec
     ...
     FUNCTION dfti_set_value_chars(desc, OptName, Chars)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_set_value_chars' :: dfti_set_value_chars
  ...
  INTERFACE DftiGetValue
     ...
     FUNCTION dfti_get_value_intval(desc, OptName, IntVal)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_get_value_intval' :: dfti_get_value_intval
     ...
     FUNCTION dfti_get_value_sglval(desc, OptName, sglval)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_get_value_sglval' :: dfti_get_value_sglval
     ...
     FUNCTION dfti_get_value_dblval(desc, OptName, DblVal)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_get_value_dblval' :: dfti_get_value_dblval
     ...
     FUNCTION dfti_get_value_intvec(desc, OptName, IntVec)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_get_value_intvec' :: dfti_get_value_intvec
     ...
     FUNCTION dfti_get_value_chars(desc, OptName, Chars)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_get_value_chars' :: dfti_get_value_chars
  ...
  INTERFACE DftiComputeForward
     ...
     FUNCTION dfti_compute_forward_s(desc,sSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_s' :: dfti_compute_forward_s
     ...
     FUNCTION dfti_compute_forward_c(desc,cSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_c' :: dfti_compute_forward_c
     ...
     FUNCTION dfti_compute_forward_ss(desc,sSrcDstRe,sSrcDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_ss' :: dfti_compute_forward_ss
     ...
     FUNCTION dfti_compute_forward_sc(desc,sSrc,cDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_sc' :: dfti_compute_forward_sc
     ...
     FUNCTION dfti_compute_forward_cc(desc,cSrc,cDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_cc' :: dfti_compute_forward_cc
     ...
     FUNCTION dfti_compute_forward_ssss(desc,sSrcRe,sSrcIm,sDstRe,sDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_ssss' :: dfti_compute_forward_ssss
     ...
     FUNCTION dfti_compute_forward_d(desc,dSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_d' :: dfti_compute_forward_d
     ...
     FUNCTION dfti_compute_forward_z(desc,zSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_z' :: dfti_compute_forward_z
     ...
     FUNCTION dfti_compute_forward_dd(desc,dSrcDstRe,dSrcDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_dd' :: dfti_compute_forward_dd
     ...
     FUNCTION dfti_compute_forward_dz(desc,dSrc,zDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_dz' :: dfti_compute_forward_dz
     ...
     FUNCTION dfti_compute_forward_zz(desc,zSrc,zDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_zz' :: dfti_compute_forward_zz
     ...
     FUNCTION dfti_compute_forward_dddd(desc,dSrcRe,dSrcIm,dDstRe,dDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_forward_dddd' :: dfti_compute_forward_dddd
  ...
  INTERFACE DftiComputeBackward
     ...
     FUNCTION dfti_compute_backward_s(desc,sSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_s' :: dfti_compute_backward_s
     ...
     FUNCTION dfti_compute_backward_c(desc,cSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_c' :: dfti_compute_backward_c
     ...
     FUNCTION dfti_compute_backward_ss(desc,sSrcDstRe,sSrcDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_ss' :: dfti_compute_backward_ss
     ...
     FUNCTION dfti_compute_backward_cs(desc,cSrc,sDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_cs' :: dfti_compute_backward_cs
     ...
     FUNCTION dfti_compute_backward_cc(desc,cSrc,cDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_cc' :: dfti_compute_backward_cc
     ...
     FUNCTION dfti_compute_backward_ssss(desc,sSrcRe,sSrcIm,sDstRe,sDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_ssss' :: dfti_compute_backward_ssss
     ...
     FUNCTION dfti_compute_backward_d(desc,dSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_d' :: dfti_compute_backward_d
     ...
     FUNCTION dfti_compute_backward_z(desc,zSrcDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_z' :: dfti_compute_backward_z
     ...
     FUNCTION dfti_compute_backward_dd(desc,dSrcDstRe,dSrcDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_dd' :: dfti_compute_backward_dd
     ...
     FUNCTION dfti_compute_backward_zd(desc,zSrc,dDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_zd' :: dfti_compute_backward_zd
     ...
     FUNCTION dfti_compute_backward_zz(desc,zSrc,zDst)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_zz' :: dfti_compute_backward_zz
     ...
     FUNCTION dfti_compute_backward_dddd(desc,dSrcRe,dSrcIm,dDstRe,dDstIm)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_compute_backward_dddd' :: dfti_compute_backward_dddd
  ...
  INTERFACE DftiFreeDescriptor
     ...
     FUNCTION dfti_free_descriptor_external(desc)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_free_descriptor_external' :: dfti_free_descriptor_external
  ...
  INTERFACE DftiErrorClass
     ...
     FUNCTION dfti_error_class_external(Status, ErrorClass)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_error_class_external' :: dfti_error_class_external
  ...
  INTERFACE DftiErrorMessage
     ...
     FUNCTION dfti_error_message_external(Status)
       USE MKL_DFT_TYPE
       !DEC$ ATTRIBUTES DECORATE,ALIAS:'dfti_error_message_external' :: dfti_error_message_external
