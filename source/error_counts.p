...
plot './phase_error_5.dat' u ($2):($3*2*pi/1024) w l ls 1 ti "Contrast: 5%",\
    './phase_error_25.dat' u ($2):($3*2*pi/1024) w l ls 2 ti "25%",\
    './phase_error_50.dat' u ($2):($3*2*pi/1024) w l ls 3 ti "50%",\
    './phase_error_75.dat' u ($2):($3*2*pi/1024) w l ls 4 ti "75%",\
    './phase_error_95.dat' u ($2):($3*2*pi/1024) w l ls 5 ti "95%"
set output
